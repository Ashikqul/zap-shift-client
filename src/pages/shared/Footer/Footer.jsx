      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="space-y-4">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
            Innovating for a better tomorrow. We specialize in delivering top-notch digital marketing strategies and building modern, responsive websites that help businesses grow and thrive online. Let’s create impactful solutions together that empower your brand and drive real results.
          </p>
          <div className="flex space-x-5 pt-2">
            <a href="#" className="text-gray-500 hover:text-[#CBEC68] dark:text-gray-400 dark:hover:text-teal-400 transition-transform transform hover:scale-110" aria-label="GitHub">
              <GitHubIcon size={28} />
            </a>
            <a href="#" className="text-gray-500 hover:text-[#CBEC68] dark:text-gray-400 dark:hover:text-teal-400 transition-transform transform hover:scale-110" aria-label="Twitter">
              <TwitterIcon size={28} />
            </a>
            <a href="#" className="text-gray-500 hover:text-[#CBEC68] dark:text-gray-400 dark:hover:text-teal-400 transition-transform transform hover:scale-110" aria-label="LinkedIn">
          ...
          <ul className="space-y-3">
            <li>
              <NavLink
                to="/"
                className={({ isActive }) =>
                  "text-gray-600 dark:text-gray-300 hover:text-[#CBEC68] dark:hover:text-teal-400 transition-colors duration-300 " +
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 dark:text-gray-300">Phone: +8801777629360</p>
        </div>
      </div>
