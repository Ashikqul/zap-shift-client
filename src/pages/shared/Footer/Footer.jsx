      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="space-y-4">
          ...
          <div className="flex space-x-5 pt-2">
            <a href="#" className="text-gray-500 hover:text-[#CBEC68] dark:text-gray-400 dark:hover:text-teal-400 transition-transform transform hover:scale-110">
              <GitHubIcon size={28} />
            </a>
            <a href="#" className="text-gray-500 hover:text-[#CBEC68] dark:text-gray-400 dark:hover:text-teal-400 transition-transform transform hover:scale-110">
              <TwitterIcon size={28} />
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            <li>
              <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-[#CBEC68] dark:hover:text-teal-400 transition-colors duration-300">
                Home
              </a>
            </li>
            <li>
